(function () {
    $(function () {
        ...
        var _$form = $('form[name=withdrawalEditForm]');
        ...
        _$form.find('button[type="submit"]').click(function (e) {
            ...
            abp.ajax({
                url: abp.appPath + 'Withdrawals/EditWithdrawal',
                type: 'POST',
                ...
                success: function (result) {
                    //console.log(result);
                    var withdrawalId = result.id;
                    location.href = "/Withdrawals/View?withdrawalId=" + withdrawalId;
                },
